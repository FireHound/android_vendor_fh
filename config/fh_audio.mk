#
# FireHound Audio Files
#

ALARM_PATH := vendor/fh/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/fh/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/fh/prebuilt/common/media/audio/ringtones
UI_PATH := vendor/fh/prebuilt/common/media/audio/ui
