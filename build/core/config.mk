...
BUILD_MAVEN_PREBUILT := $(TOP)/vendor/firehound/build/core/maven_artifact.mk
PUBLISH_MAVEN_PREBUILT := $(TOP)/vendor/firehound/build/core/maven_artifact_publish.mk
